...
for(counter11 = 0; counter11 <= sampleArray.length - 1; counter11 += 1) {
    ...
    newElement.append(counter11)
    parentElement.append(newElement)
    data.append(sampleArray[counter11] + " ")
}
...
for(counter12 = 0; counter12 <= sampleArray.length - 1; counter12 += 1) {
    ...
    parentElement.append(newElement)
    data.append(sampleArray[counter12] + " ")
}
}
...
for(counter13 = 0; counter13 <= sampleArray.length - 1; counter13 += 1) {
    ...
    parentElement.append(newElement)
    data.append(sampleArray[counter13] + " ")
}
}
...
for(counter14 = 0; counter14 <= sampleArray.length - 1; counter14 += 1) {
    let newElement = document.createElement ('p')
    if (sampleArray[counter14] % 2 ==0){
    newElement.append(sampleArray[counter14])
    parentElement.append(newElement)
    data.append(Math.pow(sampleArray[counter14], 2) + " ")
}
}
